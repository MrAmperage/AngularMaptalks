...
export { default as MapService } from "./lib/Modules/AngularMaptalksModule/Services/MapService/MapService";
export { default as MapComponent } from "./lib/Modules/AngularMaptalksModule/Components/MapComponent/MapComponent";
